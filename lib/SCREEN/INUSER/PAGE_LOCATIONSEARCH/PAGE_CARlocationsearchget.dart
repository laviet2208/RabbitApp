...
import 'package:rabbitshipping/SCREEN/LOCATION/SCREEN_LOCATION_CAR_ST2.dart';
...
class PAGEcarlocationsearchget extends StatefulWidget {
  final List<AutocompletePrediction> placePredictions;
  const PAGEcarlocationsearchget({Key? key, required this.placePredictions}) : super(key: key);

  @override
  State<PAGEcarlocationsearchget> createState() => _PAGEcarlocationsearchgetState();
}

class _PAGEcarlocationsearchgetState extends State<PAGEcarlocationsearchget> {
                    ...
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder:(context) => SCREENmappicker(type: 21,)));
                          },
