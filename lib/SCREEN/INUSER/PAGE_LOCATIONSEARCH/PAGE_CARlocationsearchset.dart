...
class PAGEcarlocationsearchset extends StatefulWidget {
  final List<AutocompletePrediction> placePredictions;
  const PAGEcarlocationsearchset({Key? key, required this.placePredictions}) : super(key: key);

  @override
  State<PAGEcarlocationsearchset> createState() => _PAGEcarlocationsearchsetState();
}

class _PAGEcarlocationsearchsetState extends State<PAGEcarlocationsearchset> {
                    ...
                    children: <Widget>[
                                ...
                                itemBuilder: (context, index) {
                                  return ITEMplaceAutoComplete(location: widget.placePredictions[index], width: screenWidth,
                                    onTap: () async {
                                      ...
                                      toastMessage('bạn đã chọn điểm đón là ' + bikeSetLocation.firstText);
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder:(context) => SCREENmappicker(type: 2,)));
                          },
