...
class PAGElocationsearchfoodset extends StatefulWidget {
  final List<AutocompletePrediction> placePredictions;
  const PAGElocationsearchfoodset({Key? key, required this.placePredictions}) : super(key: key);

  @override
  State<PAGElocationsearchfoodset> createState() => _PAGElocationsearchsetState();
}

class _PAGElocationsearchsetState extends State<PAGElocationsearchfoodset> {
                    ...
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder:(context) => SCREENmappicker(type: 4,)));
                          },
