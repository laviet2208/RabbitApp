...
class SCREENlocationbikest1test extends StatefulWidget {
  const SCREENlocationbikest1test({Key? key}) : super(key: key);

  @override
  State<SCREENlocationbikest1test> createState() => _SCREENlocationbikest1State();
}

class _SCREENlocationbikest1State extends State<SCREENlocationbikest1test> {
  ...
  Widget getBodyWidget() {
    switch (selectedIndex) {
      case 1 :
        return Pagelocationsearchget(placePredictions: placePredictions,);
      case 0 :
        return PAGElocationsearchset(placePredictions : placePredictions);
      default:
        return Container();
    }
  }
