...
class SCREENlocationbikest2 extends StatefulWidget {
  ...
  const SCREENlocationbikest2({Key? key, required this.Distance}) : super(key: key);
                                      ...
                                      child: Container(
                                        ...
                                        child: ButtonType1(Height: screenHeight/10, Width: screenWidth/2 - 20, color: Color.fromARGB(255, 238, 250, 250), radiusBorder: 30, title: 'Ưu đãi', fontText: 'arial', colorText: Color.fromARGB(255, 30, 72, 64),
                                            onTap: () {
                                              ...
                                              Navigator.push(context, MaterialPageRoute(builder:(context) => SCREENvoucherchosen(type: 1, distance: widget.Distance,)));
                                            }
                                        ),
                                      ),
                                    )
